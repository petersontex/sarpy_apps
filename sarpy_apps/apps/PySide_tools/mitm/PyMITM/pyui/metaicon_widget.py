...
class Ui_MetaIcon(object):
    def setupUi(self, MetaIcon):
        if not MetaIcon.objectName():
            MetaIcon.setObjectName("MetaIcon")
        ...
        self.content_frame.setStyleSheet("background-color: #88000000")
        ...
        self.upper_table.setStyleSheet("background-color: #00000000")
        ...
        self.lower_table.setStyleSheet("background-color: #00000000")
        ...
        self.metaicon_plot.setObjectName("metaicon_plot")
        self.metaicon_plot.setStyleSheet("background-color: #00000000")
    ...
    def retranslateUi(self, MetaIcon):
        MetaIcon.setWindowTitle(
            QCoreApplication.translate("MetaIcon", "MetaIcon", None)
        )
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("MetaIcon", ".", None))
        ___qtablewidgetitem1 = self.upper_table.item(1, 0)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MetaIcon", ".", None))
        ___qtablewidgetitem2 = self.upper_table.item(2, 0)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MetaIcon", ".", None))
        ___qtablewidgetitem3 = self.upper_table.item(3, 0)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MetaIcon", ".", None))
        ...
        ___qtablewidgetitem4.setText(
            QCoreApplication.translate("MetaIcon", "Azimuth", None)
        )
        ___qtablewidgetitem5 = self.lower_table.item(1, 0)
        ___qtablewidgetitem5.setText(
            QCoreApplication.translate("MetaIcon", "Graze", None)
        )
        ___qtablewidgetitem6 = self.lower_table.item(2, 0)
        ___qtablewidgetitem6.setText(
            QCoreApplication.translate("MetaIcon", "Layover", None)
        )
        ___qtablewidgetitem7 = self.lower_table.item(3, 0)
        ___qtablewidgetitem7.setText(
            QCoreApplication.translate("MetaIcon", "Shadow", None)
        )
        ___qtablewidgetitem8 = self.lower_table.item(4, 0)
        ___qtablewidgetitem8.setText(
            QCoreApplication.translate("MetaIcon", "Multipath", None)
        )
