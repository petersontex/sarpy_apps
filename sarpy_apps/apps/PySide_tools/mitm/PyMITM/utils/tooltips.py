class ToolTips:
    ...
    def add_plot_button() -> str:
        return """Creates a new empty plot"""

    class FileDialog:
        def favorite_directories_window() -> str:
            return """
        ...
        def directory_contents_window() -> str:
            return """
    ...
    class Plotter:
        ...
        def downsample_method_combobox() -> str:
            return """
            <p>Choose the downsampling method to use</p>
            """

        def remap_method_combobox() -> str:
            return """
            <p>Choose the remapping method to use</p>
            """

        def aspect_ratio_combobox() -> str:
            return """
            <p>Change the aspect ratio</p>
            """

        def meta_icon_button() -> str:
            return """
